...
keycache.MakeKeyCache = function() {
  var keys = [];
  var pushListener = null;
  var popListener = null;
  var keyLimit = keycache.CACHE_TARGET;
  ...
  var cache = {
    ...
    push: function(key) {
      ...
      if (count >= keyLimit) {
        ...
        keyLimit = keycache.CACHE_TARGET;
      }
...
keycache.startFiller = function(cache) {
  ...
  var postGenerateKey = function() {
    ...
    if (hasStrongRandom) {
      ...
      request.seed = keycache.getEntropyBytes(32);
    }
